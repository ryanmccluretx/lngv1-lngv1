...
module.exports = {
  ...
  getAllServicesEntries: ({extensions = codeTypes} = {}) => {
    const servicesPath = getServicesPath(true);
    if (fs.existsSync(servicesPath)) {
      return createEntryObject(servicesPath, extensions, 'services/');
    }
  ...
  getAllLibrariesEntries: ({extensions = codeTypes} = {}) => {
    const librariesPath = getLibrariesPath(true);
    if (fs.existsSync(librariesPath)) {
      return createEntryObject(librariesPath, extensions, 'libraries/');
    }
